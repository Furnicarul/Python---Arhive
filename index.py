...
def speedtest():
    ...
    if not args.simple:
        print_('\033[1;31mRetrieving KeyBash.github.io configuration...')
    try:
        config = getConfig()
    except URLError:
    ...
    if not args.simple:
        print_('\033[1;31mRetrieving KeyBash server list...\033[1;m')
    ...
    if not args.simple:
        print_('\033[1;31mTesting from\033[1;m \033[1;33m%(isp)s\033[1;m (\033[1;31mx.x.x.x\033[1;m)\033[1;31m...' % config['client'])
    ...
    if args.server:
        ...
        if not args.simple:
            print_('\033[1;31mSelecting best server based on latency...\033[1;m')
        best = getBestServer(servers)

    if not args.simple:
        print_(('\033[1;31mHosted by \033[1;33m%(sponsor)s\033[1;m (\033[1;33m%(name)s\033[1;m) \033[1;m[\033[1;31m%(d)0.2f km\033[1;m]\033[1;30m:\033[1;33m '
    ...
    if not args.simple:
        print_()
    print_('Download: \033[1;33m%0.2f M%s/s' %
    ...
    if not args.simple:
        print_()
    print_('Upload: \033[1;33m%0.2f M%s/s\033[1;m' %
